...
//
//    static snap::dispatcher<daemon>::dispatcher_match::vector_t const    g_snaplock_service_messages;
//
...
//    QString                             f_server_name = QString();
//    QString                             f_service_name = QString("cluck");
